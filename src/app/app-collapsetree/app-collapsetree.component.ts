...
@Component({
  selector: 'app-app-collapsetree',
  templateUrl: './app-collapsetree.component.html',
  styleUrls: ['./app-collapsetree.component.scss']
})
export class AppCollapsetreeComponent implements OnInit  {
